        ...
        <div class="info">
            ...
            <div class="homepage">
                ...
                <span class="homepage__logo">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 53.5" xml:space="preserve" fill="#3D3329">
                        <g>
        ...
        <div class="navigation">
            ...
            <div class="languages">
                <?php foreach (pll_the_languages(['raw' => true]) as $code => $locale) : ?>
                    <a href="<?= $locale['url']; ?>" lang="<?= $locale['locale']; ?>" hreflang="<?= $locale['locale']; ?>" class="languages__locale <?= $locale['current_lang'] ? ' languages__locale--current' : '' ?>" title="<?= $locale['name']; ?>"><?= $code; ?></a>
                <?php endforeach; ?>
            </div>
        </div>
    </header>